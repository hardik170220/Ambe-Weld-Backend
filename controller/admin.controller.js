...
export const addBookByAdmin = async (req, res, next) => {
  try {
    ...
    const {material,design, brand, usage, openStyle, color, image, price, rating } = req.body;


    const bookDetails = new Book({material,design, brand, usage, openStyle, color, image, price, rating
    })
